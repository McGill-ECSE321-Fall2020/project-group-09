<template>
  <div id="Account">
    ...
    <el-table :data = "purchases">
      ...
      <!-- Delivery details in expanded area -->
    ...
    <el-table :data = "artPieces">
      ...
      <!-- Purchase details in expanded area -->
      <el-table-column type = "expand">
        <template slot-scope="scope">

          <span v-if="!artPieces[scope.$index].purchase"> 
            <p> The art piece is not yet purchased. </p>
          </span>

          <!-- Expanded area for sold items only -->
          <span v-if="artPieces[scope.$index].purchase"> 
            ...
            <!-- Information for parcel delivery only -->
            <span v-if="artPieces[scope.$index].purchase.parcelDelivery">
              ...
              <!-- Dialog shown when updating parcel delivery information -->
              <el-dialog
            ...
            <!-- Information for in-store pick-up only -->
            <span v-if="artPieces[scope.$index].purchase.inStorePickUp">
              ...
              <!-- Dialog when updating in-store pick-up information -->
              <el-dialog
    ...
    <el-table :data = "addresses">
      ...
      <!-- Expanded area for full address -->
      <el-table-column type="expand">
